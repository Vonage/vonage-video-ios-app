...
if command -v sonar-scanner &> /dev/null; then
    ...
    if sonar-scanner -Dsonar.projectKey="$SONAR_PROJECT_KEY" \
        ...
        -Dsonar.tests=VERA/VERACore/VERACoreTests,VERA/VERAOpenTok/VERAOpenTokTests,VERA/VERAApp/VERAUITests \
...
TEST_PATHS=("VERA/VERACore/VERACoreTests" "VERA/VERAOpenTok/VERAOpenTokTests" "VERA/VERAApp/VERAUITests")
