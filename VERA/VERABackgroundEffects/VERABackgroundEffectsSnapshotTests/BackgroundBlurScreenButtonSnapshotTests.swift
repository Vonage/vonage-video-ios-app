...
@Suite("BackgroundBlurScreenButton UI Tests")
@MainActor
struct BackgroundBlurScreenButtonSnapshotTests {

    // MARK: - Test Configuration

    private let isRecording = false
    private let snapshotPrefix = "BackgroundBlurScreenButton"

    // MARK: - Core UI Tests

    @Test(
        "BackgroundBlurScreenButton - Color Schemes and Video Effects",
        arguments: [
    ...
    func colorSchemesAndVideoEffects(
        ...
        let sut = BackgroundBlurScreenButton(viewModel: viewModel)
