...
///
/// `OpenTokSubscriber` represents a single remote participant’s media stream. It provides a SwiftUI-compatible view,
...
/// - Handle OpenTok subscriber delegate callbacks (connect, errors, audio levels, captions)
///
...
public class OpenTokSubscriber: NSObject {
    /// The underlying OpenTok subscriber.
...
extension OpenTokSubscriber: OTSubscriberDelegate {
    /// OpenTok subscriber delegate callback when connection completes.
    ///
    ...
    /// OpenTok subscriber delegate callback for errors.
    ///
...
extension OpenTokSubscriber: OTSubscriberKitAudioLevelDelegate {
    /// OpenTok audio level delegate callback.
    ///
...
extension OpenTokSubscriber: OTSubscriberKitCaptionsDelegate {
    /// OpenTok captions delegate callback.
    ///
