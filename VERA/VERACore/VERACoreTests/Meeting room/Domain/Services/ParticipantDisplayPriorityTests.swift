...
struct ParticipantDisplayPriorityTests {
    ...
    private func makeUIParticipant(
        id: String,
        name: String,
        ...
        return UIParticipant(participant: participant, isPinned: isPinned)
    }
    ...
    func testScreenshareParticipantsHighestPriority() async throws {
        let participants = [
            ...
            makeUIParticipant(
                id: "3", name: "Another Regular", creationTime: Date(timeIntervalSince1970: 500),
                isScreenshare: false),
        ]
    ...
    func testMultipleScreenshareParticipants() async throws {
        let participants = [
            ...
            makeUIParticipant(
                id: "4", name: "Another Regular", creationTime: Date(timeIntervalSince1970: 500),
                isScreenshare: false),
        ]

        let sorted = participants.sortedByDisplayPriority(activeSpeakerId: nil)

        // Screenshare participants by creation time (3 before 2), then regular participants by creation time
    ...
    func testMultiplePinnedParticipants() async throws {
        ...
        // Pinned participants maintain current order (2, 3), then regular participants by creation time
    ...
    func testNoActiveSpeaker() async throws {
        let participants = [
            makeUIParticipant(id: "1", name: "Regular1", creationTime: Date(timeIntervalSince1970: 2000)),
            makeUIParticipant(id: "2", name: "Regular2", creationTime: Date(timeIntervalSince1970: 1000)),
            makeUIParticipant(id: "3", name: "Regular3", creationTime: Date(timeIntervalSince1970: 1500)),
        ]
    ...
    func testSingleParticipant() async throws {
        let participants = [
            makeUIParticipant(id: "1", name: "OnlyOne", creationTime: Date(timeIntervalSince1970: 1000))
        ]
    ...
    func testStaticSortByDisplayPriorityMethod() async throws {
        let participants = [
            makeUIParticipant(id: "1", name: "Regular", creationTime: Date(timeIntervalSince1970: 1000)),
            makeUIParticipant(id: "2", name: "Speaker", creationTime: Date(timeIntervalSince1970: 1500)),
            makeUIParticipant(
                id: "3", name: "Pinned", creationTime: Date(timeIntervalSince1970: 2000), isPinned: true),
        ]
    ...
    func testParticipantWithAllSpecialProperties() async throws {
        let participants = [
            makeUIParticipant(id: "1", name: "Regular", creationTime: Date(timeIntervalSince1970: 1000)),
            makeUIParticipant(
                id: "2", name: "SuperParticipant", creationTime: Date(timeIntervalSince1970: 1500),
                isScreenshare: true,
                isPinned: true),
        ]
    ...
    func testIdenticalNamesSortedByCreationDate() async throws {
        let participants = [
            makeUIParticipant(id: "1", name: "John", creationTime: Date(timeIntervalSince1970: 2000)),
            makeUIParticipant(id: "2", name: "John", creationTime: Date(timeIntervalSince1970: 1000)),
            makeUIParticipant(id: "3", name: "John", creationTime: Date(timeIntervalSince1970: 1500)),
        ]
    ...
    func testIdenticalCreationTimesSortedByName() async throws {
        ...
        let participants = [
            makeUIParticipant(id: "1", name: "Charlie", creationTime: sameTime),
            makeUIParticipant(id: "2", name: "Alice", creationTime: sameTime),
            makeUIParticipant(id: "3", name: "Bob", creationTime: sameTime),
        ]
