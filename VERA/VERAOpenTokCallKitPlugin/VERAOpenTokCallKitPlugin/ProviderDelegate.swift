...
/// - Pre-heat and manage the `AVAudioSession` using OpenTok’s audio session manager
...
final class ProviderDelegate: NSObject, CXProviderDelegate {
    ...
    ///   - sessionManager: Optional OpenTok audio session manager to handle activation and mode.
    ///
    ...
    ///
    /// Forwards activation to the OpenTok session manager.
