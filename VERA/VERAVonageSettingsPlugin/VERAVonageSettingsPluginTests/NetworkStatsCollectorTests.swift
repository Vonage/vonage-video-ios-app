...
struct NetworkStatsCollectorTests {
    ...
    func publisherAudioStatsUpdateCorrectly() async {
        ...
        let audioStats = [MockAudioSendStats(
            packetsSent: 100,
            packetsLost: 5,
            bytesSent: 1000,
            timestamp: 1.0
    ...
    func publisherVideoStatsUpdateCorrectly() async {
        ...
        let videoStats = [MockVideoSendStats(
            packetsSent: 200,
            packetsLost: 10,
            bytesSent: 2000,
            timestamp: 2.0
    ...
    func publisherRtcStatsExtractsVideoCodec() async {
        ...
        let rtcStats = MockPublisherRtcStats(jsonArrayOfReports: """
        [
    ...
    func statsFromMultipleSourcesAggregateCorrectly() async {
        ...
        // Add publisher audio
        let audioSendStats = [MockAudioSendStats(
            packetsSent: 100,
            packetsLost: 5,
            bytesSent: 1000,
            timestamp: 1.0
        ...
        // Add publisher video
        let videoSendStats = [MockVideoSendStats(
            packetsSent: 200,
            packetsLost: 10,
            bytesSent: 2000,
            timestamp: 2.0
