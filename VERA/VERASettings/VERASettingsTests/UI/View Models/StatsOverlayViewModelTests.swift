...
struct StatsOverlayViewModelTests {
    ...
    func testInitialStateObservesStats() async throws {
        ...
        let stats = NetworkMediaStats(
            sentAudio: AudioSendStats(packetsSent: 100, packetsLost: 0, bytesSent: 5000, timestamp: 1000, audioCodec: "opus"),
            sentVideo: VideoSendStats(packetsSent: 50, packetsLost: 0, bytesSent: 10000, timestamp: 1000, videoCodec: "VP8"),
    ...
    func testStatsTextUpdatesWithNewStats() async throws {
        ...
        let stats2 = NetworkMediaStats(
            sentAudio: AudioSendStats(packetsSent: 200, packetsLost: 0, bytesSent: 10000, timestamp: 2000, audioCodec: "opus"),
            sentVideo: VideoSendStats(packetsSent: 100, packetsLost: 0, bytesSent: 20000, timestamp: 2000, videoCodec: "VP8"),
            receivedAudio: AudioReceiveStats(packetsReceived: 180, packetsLost: 2, bytesReceived: 9000, timestamp: 2000),
